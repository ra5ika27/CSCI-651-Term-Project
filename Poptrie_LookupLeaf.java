...
public class Poptrie_LookupLeaf {
    /**
    ...
    void lookup(Poptrie_NodeLeaf root, ArrayList<Poptrie_NodeLeaf> N, ArrayList<String> L, String key){
        ...
        try {
            ...
            //Calculate number of ones in
            //least signoficant n+1 bits in the leafvector
            bc = popcnt(v, N.get(index).leafvec);
